                        ...
                        <div class="card-box">
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover table-centered m-0">
                                    ...
                                    <tr>
                                        <td>
                                            <img src="${pageContext.request.contextPath}/assets/images/users/avatar-2.jpg"
                                    ...
                                    <tr>
                                        <td>
                                            <img src="${pageContext.request.contextPath}/assets/images/users/avatar-3.jpg"
                                                 alt="contact-img" title="contact-img" class="rounded-circle thumb-sm"/>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <img src="${pageContext.request.contextPath}/assets/images/users/avatar-4.jpg"
                                                 alt="contact-img" title="contact-img" class="rounded-circle thumb-sm"/>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <img src="${pageContext.request.contextPath}/assets/images/users/avatar-5.jpg"
                                                 alt="contact-img" title="contact-img" class="rounded-circle thumb-sm"/>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <img src="${pageContext.request.contextPath}/assets/images/users/avatar-6.jpg"
                                                 alt="contact-img" title="contact-img" class="rounded-circle thumb-sm"/>
                                        </td>
...
<!-- Flot chart -->
<script src="${pageContext.request.contextPath}/plugins/flot-chart/jquery.flot.min.js"></script>
<script src="${pageContext.request.contextPath}/plugins/flot-chart/jquery.flot.time.js"></script>
<script src="${pageContext.request.contextPath}/plugins/flot-chart/jquery.flot.tooltip.min.js"></script>
<script src="${pageContext.request.contextPath}/plugins/flot-chart/jquery.flot.resize.js"></script>
<script src="${pageContext.request.contextPath}/plugins/flot-chart/jquery.flot.pie.js"></script>
<script src="${pageContext.request.contextPath}/plugins/flot-chart/jquery.flot.crosshair.js"></script>
<script src="${pageContext.request.contextPath}/plugins/flot-chart/curvedLines.js"></script>
<script src="${pageContext.request.contextPath}/plugins/flot-chart/jquery.flot.axislabels.js"></script>
